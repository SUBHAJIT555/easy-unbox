...
const ShopFilterOffCanvas = ({
  ...
  return (
    <>
      <div
        className={`easyunbox-filter-offcanvas ${
          filterSidebar ? "offcanvas-opened" : ""
        }`}
      >
        <div className="easyunbox-filter-offcanvas__panel">
          <div className="easyunbox-filter-offcanvas__header">
            <button
              type="button"
              onClick={() => dispatch(handleFilterSidebarOpen())}
              className="easyunbox-filter-offcanvas__close"
          ...
          <div className="easyunbox-filter-offcanvas__sidebar">
            {/* filter */}
            <PriceFilter
