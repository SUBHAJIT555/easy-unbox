...
// internal
import { AddCart, AskQuestion, WishlistTwo } from '@/svg';
  ...
  return (
    <div className="tp-product-details-wrapper">
      ...
      <div className="tp-product-details-action-sm">
        <button disabled={status === 'out-of-stock'} onClick={() => handleAddProduct(productItem)} type="button" className="tp-product-details-action-sm-btn">
          <AddCart />
          Add To Cart
        </button>
