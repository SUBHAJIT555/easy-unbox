<?php
/**
 * Easy Unbox mailer — PHP 7.4 compatible (no Composer required).
...
$brandName = envVal('MAIL_FROM_NAME', 'Easy Unbox');
$brandColor = '#ea580c';
$border = '#e5e5e5';
$toEmail = envVal('MAIL_TO', 'info@easy-unbox.com');

if ($formType === 'contact') {
    $subject = 'New Contact Inquiry - Easy Unbox - ' . $name;
} elseif ($formType === 'newsletter' || $formType === 'cta') {
    $subject = 'New Newsletter Signup - Easy Unbox - ' . $email;
} else {
    $subject = 'New Quote Request - Easy Unbox - ' . $name;
}
